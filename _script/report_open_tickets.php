...
WHERE s.IsOpen =1 
  AND t.CreatedDatetime < DATE_SUB(NOW(), INTERVAL 14 DAY) 
...
<body>
    <div class="header">
        <h1>Open Tickets Report</h1>
        <p>Tickets that have been open for 14 days</p>
    </div>';
...
foreach ($agents as $agent) {
	...
	$agent->sendMailMessage(count($tickets) . " offene Tickets", $emailBody);
}
